...
export const AppointmentLinkButton = () => {
    return (
        <Button variant="default" className="w-full sm:w-auto px-6 py-5 font-bold" asChild>
...
export const WhatsappLinkButton = ({ children, whatsAppNumber }: { children: React.ReactNode, whatsAppNumber: string }) => {
    return (
        <Button variant="outline" className="w-full sm:w-auto px-6 py-5 font-bold" asChild>
            <a
